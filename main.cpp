...
PCL int OnInit(){ //Function executed after the plugin is loaded on the server.
	try {
		...
		IPIntel::SetBanMessage(Plugin_Cvar_RegisterString("vpn_blocker_kick_msg", "Usage of a VPN or Proxy is not allowed on this server!", 0, "The message to be shown to the user when they are denied access to the server"));
